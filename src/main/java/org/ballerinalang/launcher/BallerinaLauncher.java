...
public class BallerinaLauncher {
    ...
    public BallerinaLauncher(String... args) {
        try {
            Optional<org.ballerinalang.launcher.BLauncherCmd> optionalInvokedCmd = getInvokedCmd(args);
            optionalInvokedCmd.ifPresent(org.ballerinalang.launcher.BLauncherCmd::execute);
        } catch (ParserException | SemanticException | BLangRuntimeException e) {
            outStream.println(e.getMessage());
            Runtime.getRuntime().exit(1);
        } catch (org.ballerinalang.launcher.BLauncherException e) {
    ...
    private static Optional<org.ballerinalang.launcher.BLauncherCmd> getInvokedCmd(String... args) {
        try {
            ...
            ServiceLoader<org.ballerinalang.launcher.BLauncherCmd> bCmds = ServiceLoader.load(org.ballerinalang.launcher.BLauncherCmd.class);
            for (org.ballerinalang.launcher.BLauncherCmd bCmd : bCmds) {
            ...
            return Optional.of((org.ballerinalang.launcher.BLauncherCmd) commanderMap.get(parsedCmdName).getObjects().get(0));
    ...
    private static void printUsageInfo(JCommander cmdParser) {
        ...
        org.ballerinalang.launcher.BLauncherCmd.printCommandList(cmdParser, out);

        out.append("\n");
        org.ballerinalang.launcher.BLauncherCmd.printFlags(cmdParser.getParameters(), out);
    ...
    private static class RunCmd implements org.ballerinalang.launcher.BLauncherCmd {
        ...
        public void execute() {
            if (helpFlag) {
                String commandUsageInfo = org.ballerinalang.launcher.BLauncherCmd.getCommandUsageInfo(parentCmdParser, "run");
            ...
            if (runServices) {
                ...
                org.ballerinalang.launcher.LauncherUtilsChanged.runProgram(sourceRootPath, Paths.get(argList.get(0)), true, new String[0]);
                return;
            }
            ...
            org.ballerinalang.launcher.LauncherUtilsChanged.runProgram(sourceRootPath, Paths.get(argList.get(0)), false, programArgs);
        }
    ...
    private static class BuildCmd implements org.ballerinalang.launcher.BLauncherCmd {
        ...
        public void execute() {
            if (helpFlag) {
                String commandUsageInfo = org.ballerinalang.launcher.BLauncherCmd.getCommandUsageInfo(parentCmdParser, "build");
                outStream.println(commandUsageInfo);
                return;
            }
    ...
    private static class HelpCmd implements org.ballerinalang.launcher.BLauncherCmd {
        ...
        public void execute() {
            ...
            String commandUsageInfo = org.ballerinalang.launcher.BLauncherCmd.getCommandUsageInfo(parentCmdParser, userCommand);
            outStream.println(commandUsageInfo);
        }
    ...
    private static class VersionCmd implements org.ballerinalang.launcher.BLauncherCmd {
        ...
        public void execute() {
            if (helpFlag) {
                String commandUsageInfo = org.ballerinalang.launcher.BLauncherCmd.getCommandUsageInfo(parentCmdParser, "version");
                outStream.println(commandUsageInfo);
                return;
            }
     ...
     * @since 0.8.0
     */
    private static class DefaultCmd implements org.ballerinalang.launcher.BLauncherCmd {
