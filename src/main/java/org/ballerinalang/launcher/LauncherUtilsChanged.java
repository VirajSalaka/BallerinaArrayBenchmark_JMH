...
public class LauncherUtilsChanged {
    ...
    public static void customRunfn(){
        if (myRunServices || !myProgramFile.isMainEPAvailable()) {
            runServices(myProgramFile);
        } else {
            runMain(myProgramFile, myArgs);
        }
    }
    ...
    public static org.ballerinalang.launcher.BLauncherException createUsageException(String errorMsg) {
        org.ballerinalang.launcher.BLauncherException launcherException = new org.ballerinalang.launcher.BLauncherException();
        launcherException.addMessage("ballerina: " + errorMsg);
        launcherException.addMessage("Run 'ballerina help' for usage.");
        return launcherException;
    }

    static org.ballerinalang.launcher.BLauncherException createLauncherException(String errorMsg) {
        org.ballerinalang.launcher.BLauncherException launcherException = new org.ballerinalang.launcher.BLauncherException();
        launcherException.addMessage(errorMsg);
        return launcherException;
    }

    static void printLauncherException(org.ballerinalang.launcher.BLauncherException e, PrintStream outStream) {
